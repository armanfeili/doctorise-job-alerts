...
docker rm -f Doctorise_scraper_container  # Ensure complete removal

echo "Rebuilding and starting the $service_name service (Using Cache)..."
docker-compose -f compose.yml up --build -d $service_name  # Rebuild with cache
